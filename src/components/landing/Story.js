...
const animationMixin = css`animation: ${fadeDown} 1s cubic-bezier(0.075, 0.82, 0.165, 1);`
...
const TextHalf = styled.div`
    .overlay {
        ${props => props.visible ? animationMixin : null}
...
export default function Story() {
    const txtRef = useRef()
    const isVisible = useOnScreen(txtRef, "-120px")
    return (
        <StorySection className='d-md-flex'>
            <div className='img-half' />
            <TextHalf ref={txtRef} visible={isVisible}>
